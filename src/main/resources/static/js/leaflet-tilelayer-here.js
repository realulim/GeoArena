...
/* global L, hereAppId, hereAppCode, mapsService, normal, terrain, satellite, mapboxAccessToken, defaultLayer */
...
// 		&{param}={value}
	...
	this._attributionText = options.attributions;
	...
	if (!this._attributionBBoxes) {
	    // uncomment the following line to fetch attributions from HERE
